...
class _CppLevel3State extends State<CppLevel3> {
  ...
  void _autoDragCorrectBlocks() {
    // Correct blocks for: string name = "Alex"; cout << name;
  ...
  String _getLevelHint() {
    return "The correct code is: string name = \"Alex\"; cout << name;\n\n💡 Hint: First declare a string variable, then use cout to display it. Don't forget the semicolons!";
  }
