...
class _CppLevel4State extends State<CppLevel4> {
  ...
  Future<void> _loadGameConfig() async {
    try {
      ...
      final response = await ApiService.getGameConfig('C++', 4);
  ...
  String _getDefaultHint() {
    ...
    return "💡 Hint: This is Level 4 - advanced C++ concepts! Focus on proper class structure and function definitions.";
  }
  ...
  bool isIncorrectBlock(String block) {
    ...
    // Fallback incorrect blocks for Level 4 (more advanced)
    List<String> incorrectBlocks = [
      'printf',
      'cout >>',
      'System.out.print',
  ...
  void checkAnswer() async {
    ...
    if (gameConfig != null) {
      ...
      // Fallback to original check for Level 4 (more advanced)
      String expected = 'classCar{public:stringbrand;intyear;voiddisplayInfo(){cout<<"Brand:"<<brand<<",Year:"<<year;}};intmain(){CarmyCar;myCar.brand="Toyota";myCar.year=2020;myCar.displayInfo();return0;}';
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              if (score == 3)
                Text(
                  "🎉 Perfect! You've completed C++ Level 4!",
  ...
  Widget _buildSyntaxHighlightedLine(String code) {
    ...
    } else if (code.contains('int main') || code.contains('using namespace') || code.contains('return') || code.contains('class') || code.contains('public') || code.contains('private') || code.contains('void')) {
  ...
  Widget build(BuildContext context) {
    ...
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text("⚡ C++ - Level 4", style: TextStyle(fontSize: 18)),
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      "You've mastered C++ Expert Level!",
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 5 * _scaleFactor),
                    Text(
                      "Try again to get a perfect score and complete Level 4!",
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isTagalog
                ? (gameConfig?['story_tagalog'] ?? 'Ito ay Level 4 ng C++ programming! Expert level na ito.')
                : (gameConfig?['story_english'] ?? 'This is C++ Level 4! Expert level challenge.'),
