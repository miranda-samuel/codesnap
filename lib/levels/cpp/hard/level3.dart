...
class _CppLevel3HardState extends State<CppLevel3Hard> {
  ...
  String _getLevelHint() {
    return "HARD LEVEL 3: Create a Car class with methods!\n\nBuild a class with:\n• start() method\n• Create object in main()\n• Call method to display message";
  }
  ...
  Future<void> saveScoreToDatabase(int score) async {
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        print('Score saved successfully: $score for C++ Hard Level 3');
      } else {
    ...
    try {
      ...
      if (response['success'] == true && response['scores'] != null) {
        ...
        if (level3Data != null) {
          ...
          print('Loaded previous score: $previousScore for C++ Hard Level 3');
        }
      }
    } catch (e) {
  ...
  void checkAnswer() async {
    ...
    bool hasClass = normalizedAnswer.contains('classcar{');
    bool hasPublic = normalizedAnswer.contains('public:');
    bool hasMethod = normalizedAnswer.contains('voidstart(){cout<<"carstarted!";}');
    bool hasMain = normalizedAnswer.contains('intmain(){');
    bool hasObject = normalizedAnswer.contains('carmycar;');
    bool hasMethodCall = normalizedAnswer.contains('mycar.start();');
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("Excellent! You created a complete C++ class program!"),
              SizedBox(height: 10),
              ...
              if (score == 3)
                Text(
                  "🎉 Perfect! You've mastered all Hard Levels!",
              ...
              SizedBox(height: 10),
              Text(
                "💎 Advanced Feature: You created a complete OOP program!",
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.pushReplacementNamed(context, '/levels',
                    arguments: {'language': 'C++', 'difficulty': 'Hard'});
              },
              child: Text("Continue"),
            )
          ],
  ...
  Widget _buildCodeContent() {
    ...
    for (BlockItem blockItem in droppedBlockItems) {
      ...
      bool isKeyword = block.contains('using namespace') ||
          ...
          block.contains('class Car') ||
          block.contains('public:') ||
          block.contains('void start');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("⚡ C++ - Level 3 (Hard)", style: TextStyle(fontSize: 18 * _scaleFactor)),
        backgroundColor: Colors.red,
        actions: gameStarted ? [
          Padding(
        ...
        child: Column(
          ...
          children: [
            ElevatedButton.icon(
              ...
              label: Text("Start Hard Level 3", style: TextStyle(fontSize: 16 * _scaleFactor)),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 10 * _scaleFactor),
                  Text(
                    "💡 Master: Classes, Objects, Methods, OOP",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        fontSize: 12 * _scaleFactor,
                        color: Colors.blue,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isTagalog
                ? 'Final challenge! Si Alex ay gumagawa ng Car class program. Tulungan siyang buuin ang complete OOP program gamit ang 13 blocks!'
                : 'Final challenge! Alex is creating a Car class program. Help him build the complete OOP program using 13 blocks!',
            textAlign: TextAlign.justify,
            style: TextStyle(fontSize: 16 * _scaleFactor, color: Colors.white70),
          ),
          SizedBox(height: 20 * _scaleFactor),

          Text('🧩 Build a complete Car class program using 13 blocks',
