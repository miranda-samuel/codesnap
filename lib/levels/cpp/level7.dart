...
class _CppLevel7State extends State<CppLevel7> {
  ...
  void _autoDragCorrectBlocks() {
    // Correct blocks for circle calculations
  ...
  String _getLevelHint() {
    return "The correct code is:\ndouble pi = 3.14159;\ndouble radius = 5.5;\ndouble area = pi * radius * radius;\ndouble circumference = 2 * pi * radius;\ncout << \"Area: \" << area << endl;\ncout << \"Circumference: \" << circumference << endl;\n\n💡 Hint: Use double for decimal numbers, calculate area = πr² and circumference = 2πr!";
  }
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 10 * _scaleFactor),
                  Text(
                    "🎁 Get a perfect score (3/3) to unlock the Level 8!",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        fontSize: 12 * _scaleFactor,
                        color: Colors.purple,
