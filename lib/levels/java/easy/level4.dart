...
class _JavaLevel4State extends State<JavaLevel4> {
  ...
  void _autoDragCorrectBlocks() {
    // Correct blocks for Java Level 4: String manipulation with Juan
  ...
  String _getLevelHint() {
    return "The correct code is:\nString name = \"Juan\";\nString greeting = \"Hello, \" + name;\nSystem.out.println(greeting);\n\n💡 Hint: First declare the name variable, then create the greeting by concatenating strings, and finally print the greeting using System.out.println!";
  }
