...
class JavaLevel5 extends StatefulWidget {
  const JavaLevel5({super.key});

  @override
  State<JavaLevel5> createState() => _JavaLevel5State();
}

class _JavaLevel5State extends State<JavaLevel5> {
  ...
  void resetBlocks() {
    // Correct blocks for Java: Odd/Even checker
    List<String> correctBlocks = [
      'int number = 7;',
      'if (number % 2 == 0) {',
      '    System.out.println("Even");',
  ...
  void checkAnswer() async {
    ...
    bool hasPrintEven = droppedBlocks.contains('    System.out.println("Even");');
    bool hasElse = droppedBlocks.contains('} else {');
    bool hasPrintOdd = droppedBlocks.contains('    System.out.println("Odd");');
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _buildSyntaxHighlightedLine('public class OddEven {', isKeyword: true),
  ...
  Widget _buildUserCodePreview() {
    ...
    if (hasPrintEven) {
      codeLines.add(_buildUserCodeLine('    System.out.println("Even");'));
    }
    ...
    if (hasPrintOdd) {
      codeLines.add(_buildUserCodeLine('    System.out.println("Odd");'));
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("☕ Java - Level 5", style: TextStyle(fontSize: 18 * _scaleFactor)),
        backgroundColor: Colors.red,
        actions: gameStarted
            ? [
          Padding(
