...
class _JavaLevel1HardState extends State<JavaLevel1Hard> {
  ...
  String _instructionText = '🧩 Arrange the blocks to create a Java program with conditional statements and user input';
  ...
  Future<void> _loadGameConfig() async {
    try {
      ...
      final response = await ApiService.getGameConfigWithDifficulty('Java', 'Hard', 1);

      print('🔍 JAVA HARD GAME CONFIG RESPONSE:');
  ...
  void _initializeGameFromConfig() {
    ...
    try {
      print('🔄 INITIALIZING JAVA HARD GAME FROM CONFIG');
  ...
  String _getDefaultHint() {
    return "💡 Hint: Use modulo operator % to check even/odd numbers. Remember the if-else syntax and string concatenation with +.";
  }
  ...
  void startGame() {
    ...
    print('🎮 JAVA HARD GAME STARTED - Initial Score: $score, Timer: $timerDuration seconds');
    startTimers();
  }
  ...
  Future<void> saveScoreToDatabase(int score) async {
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        print('✅ JAVA HARD SCORE SAVED SUCCESSFULLY TO DATABASE');
      } else {
        print('❌ FAILED TO SAVE SCORE: ${response['message']}');
      }
    } catch (e) {
      print('❌ ERROR SAVING JAVA HARD SCORE: $e');
    }
  }
  ...
  Future<void> loadScoreFromDatabase() async {
    ...
    try {
      ...
      print('Error loading Java hard score: $e');
    }
  }
  ...
  bool isIncorrectBlock(String block) {
    ...
    // Default incorrect blocks for Java Hard
  ...
  void checkAnswer() async {
    ...
    print('🔍 CHECKING JAVA HARD ANSWER:');
    ...
    if (gameConfig != null) {
      ...
      bool hasVariable = droppedBlocks.any((block) => block.toLowerCase().contains('int number = 7'));
      ...
      bool hasPrintEven = droppedBlocks.any((block) => block.toLowerCase().contains('system.out.println("the number " + number + " is even")'));
      bool hasPrintOdd = droppedBlocks.any((block) => block.toLowerCase().contains('system.out.println("the number " + number + " is odd")'));
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("Outstanding work Java Expert!"),
              SizedBox(height: 10),
  ...
  Widget _buildSyntaxHighlightedLine(String code, int lineNumber) {
    ...
    if (code.trim().startsWith('import') || code.trim().startsWith('public class') || code.contains('public static void main')) {
      ...
      textColor = Color(0xFF4EC9B0); // Classes - teal
    }
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text("☕ Java - Level 1 Hard", style: TextStyle(fontSize: 18)),
          backgroundColor: Colors.purple,
        ),
        body: Container(
          decoration: BoxDecoration(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                  "Loading Java Hard Game Configuration...",
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text(
                    gameConfig?['objective'] ?? "🎯 Java Level 1 Hard Objective",
                    style: TextStyle(fontSize: 18 * _scaleFactor, fontWeight: FontWeight.bold, color: Colors.purple[800]),
                    textAlign: TextAlign.center,
                  ),
                  SizedBox(height: 10 * _scaleFactor),
                  Text(
                    gameConfig?['objective'] ?? "Create a Java program with conditional statements that checks if a number is even or odd",
                    textAlign: TextAlign.center,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isTagalog
                ? (gameConfig?['story_tagalog'] ?? 'Ito ay Hard Level ng Java programming! Lumikha ng program na gumagamit ng conditional statements para suriin kung even o odd ang isang numero.')
                : (gameConfig?['story_english'] ?? 'This is Java Hard Level! Create a program using conditional statements to check if a number is even or odd.'),
