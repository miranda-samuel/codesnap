...
class JavaLevel8 extends StatefulWidget {
  const JavaLevel8({super.key});

  @override
  State<JavaLevel8> createState() => _JavaLevel8State();
}

class _JavaLevel8State extends State<JavaLevel8> {
  ...
  void _autoDragCorrectBlocks() {
    // Correct blocks for Java Level 8: String reversal method
  ...
  String _getLevelHint() {
    return "The correct code for string reversal:\n\npublic static String reverseString(String str) {\n    StringBuilder reversed = new StringBuilder();\n    for (int i = str.length() - 1; i >= 0; i--) {\n        reversed.append(str.charAt(i));\n    }\n    return reversed.toString();\n}\n\n💡 Hint: Start from the last character and move backwards. Use StringBuilder for efficient string manipulation!";
  }
  ...
  void resetBlocks() {
    // Correct blocks for Java: String manipulation - reverse a string (6 blocks)
    List<String> correctBlocks = [
      'public static String reverseString(String str) {',
      'StringBuilder reversed = new StringBuilder();',
      'for (int i = str.length() - 1; i >= 0; i--) {',
  ...
  void checkAnswer() async {
    ...
    // Check for the correct sequence for reverseString method (6 blocks)
    bool hasMethodSignature = droppedBlocks.contains('public static String reverseString(String str) {');
    bool hasStringBuilder = droppedBlocks.contains('StringBuilder reversed = new StringBuilder();');
    bool hasForLoop = droppedBlocks.contains('for (int i = str.length() - 1; i >= 0; i--) {');
    bool hasAppend = droppedBlocks.contains('reversed.append(str.charAt(i));');
    bool hasClosingBrace = droppedBlocks.contains('}');
    bool hasReturn = droppedBlocks.contains('return reversed.toString();');
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("Excellent! You've created a perfect string reversal method!"),
              SizedBox(height: 10),
              ...
              if (score == 3)
                Column(
                  children: [
                    Text(
                      "🎉 Perfect! You've completed Java Level 8!",
            ...
            TextButton(
              onPressed: () {
                ...
                if (score == 3) {
                  ...
                  Navigator.pushReplacementNamed(context, '/java_level9');
                } else {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _buildSyntaxHighlightedLine('public class StringUtils {', isKeyword: true),
                          ...
                          _buildSyntaxHighlightedLine('        System.out.println("Reversed: " + reversed);', isNormal: true),
                          _buildSyntaxHighlightedLine('    }', isNormal: true),
                          _buildSyntaxHighlightedLine('}', isNormal: true),
                        ],
                      ),
  ...
  Widget _buildUserCodePreview() {
    ...
    if (hasMethodSignature) {
      codeLines.add(_buildUserCodeLine('public static String reverseString(String str) {'));
    }

    if (hasStringBuilder) {
      codeLines.add(_buildUserCodeLine('    StringBuilder reversed = new StringBuilder();'));
    }
    ...
    if (hasAppend) {
      codeLines.add(_buildUserCodeLine('        reversed.append(str.charAt(i));'));
    }
    ...
    if (hasReturn) {
      codeLines.add(_buildUserCodeLine('    return reversed.toString();'));
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("☕ Java - Level 8", style: TextStyle(fontSize: 18 * _scaleFactor)),
        backgroundColor: Colors.red,
        actions: gameStarted
            ? [
          Padding(
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 10 * _scaleFactor),
                  Text(
                    "Create a method that reverses a string using StringBuilder",
                    textAlign: TextAlign.center,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('🧩 Arrange the 6 correct blocks to create the reverseString method',
