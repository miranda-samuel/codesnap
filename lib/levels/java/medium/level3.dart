...
class JavaLevel3Medium extends StatefulWidget {
  const JavaLevel3Medium({super.key});

  @override
  State<JavaLevel3Medium> createState() => _JavaLevel3MediumState();
}

class _JavaLevel3MediumState extends State<JavaLevel3Medium> {
  ...
  String _instructionText = '🧩 Arrange the blocks to create a Java program that calculates factorial using a for loop';
  ...
  Future<void> _loadGameConfig() async {
    try {
      ...
      final response = await ApiService.getGameConfigWithDifficulty('Java', 'Medium', 3);

      print('🔍 JAVA MEDIUM LEVEL 3 GAME CONFIG RESPONSE:');
  ...
  void _initializeGameFromConfig() {
    ...
    try {
      print('🔄 INITIALIZING JAVA MEDIUM LEVEL 3 GAME FROM CONFIG');
  ...
  List<String> _getDefaultBlocks(String type) {
    if (type == 'correct') {
      ...
      return [
        ...
        'if (factorial > 100) {',
        '    System.out.println(\"Large factorial\");',
        '}'
      ];
    }
  }
  ...
  String _getDefaultHint() {
    return "💡 Hint: Use a for loop to multiply numbers from 1 to n. Remember: factorial of n is 1*2*3*...*n. Initialize factorial to 1 before the loop.";
  }
  ...
  void startGame() {
    ...
    print('🎮 JAVA MEDIUM LEVEL 3 GAME STARTED - Initial Score: $score, Timer: $timerDuration seconds');
    startTimers();
  }
  ...
  Future<void> saveScoreToDatabase(int score) async {
    ...
    try {
      print('💾 SAVING JAVA MEDIUM LEVEL 3 SCORE:');
      ...
      if (response['success'] == true) {
        ...
        print('✅ JAVA MEDIUM LEVEL 3 SCORE SAVED SUCCESSFULLY TO DATABASE');
      } else {
        print('❌ FAILED TO SAVE SCORE: ${response['message']}');
      }
    } catch (e) {
      print('❌ ERROR SAVING JAVA MEDIUM LEVEL 3 SCORE: $e');
    }
  }
  ...
  Future<void> loadScoreFromDatabase() async {
    ...
    try {
      ...
      print('Error loading Java medium level 3 score: $e');
    }
  }
  ...
  bool isIncorrectBlock(String block) {
    ...
    // Default incorrect blocks for Java Medium Level 3
  ...
  void checkAnswer() async {
    ...
    print('🔍 CHECKING JAVA MEDIUM LEVEL 3 ANSWER:');
    ...
    if (gameConfig != null) {
      ...
      bool hasNumber = droppedBlocks.any((block) => block.toLowerCase().contains('int number = 5'));
      bool hasFactorial = droppedBlocks.any((block) => block.toLowerCase().contains('int factorial = 1'));
      bool hasForLoop = droppedBlocks.any((block) => block.toLowerCase().contains('for (int i = 1; i <= number; i++)'));
      bool hasMultiplication = droppedBlocks.any((block) => block.toLowerCase().contains('factorial *= i'));
      bool hasPrint = droppedBlocks.any((block) => block.toLowerCase().contains('system.out.println'));

      isCorrect = hasNumber && hasFactorial && hasForLoop && hasMultiplication && hasPrint;
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("Excellent work Java Programmer!"),
              SizedBox(height: 10),
  ...
  Widget _buildSyntaxHighlightedLine(String code, int lineNumber) {
    ...
    } else if (code.contains('for') || code.contains('int i = 1')) {
      textColor = Color(0xFFC586C0); // Control flow - purple
    }
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text("☕ Java - Level 3 Medium", style: TextStyle(fontSize: 18)),
          backgroundColor: Colors.orange,
        ),
        body: Container(
          decoration: BoxDecoration(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                  "Loading Java Medium Level 3 Game Configuration...",
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("☕ Java - Level 3 Medium", style: TextStyle(fontSize: 18 * _scaleFactor)),
        backgroundColor: Colors.orange,
        actions: gameStarted
            ? [
          Padding(
          ...
          children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      "Great job mastering loops and factorial calculation!",
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text(
                    gameConfig?['objective'] ?? "🎯 Java Level 3 Medium Objective",
                    style: TextStyle(fontSize: 18 * _scaleFactor, fontWeight: FontWeight.bold, color: Colors.orange[800]),
                    textAlign: TextAlign.center,
                  ),
                  SizedBox(height: 10 * _scaleFactor),
                  Text(
                    gameConfig?['objective'] ?? "Create a Java program that calculates factorial using for loops and multiplication assignment operator",
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 14 * _scaleFactor, color: Colors.orange[700]),
                  ),
                  SizedBox(height: 10 * _scaleFactor),
                  Text(
                    "⚡ Medium Difficulty: Loop logic and mathematical operations!",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        fontSize: 12 * _scaleFactor,
                        color: Colors.purple,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isTagalog
                ? (gameConfig?['story_tagalog'] ?? 'Ito ay Medium Level 3 ng Java programming! Lumikha ng program na nagkakalkula ng factorial gamit ang for loop.')
                : (gameConfig?['story_english'] ?? 'This is Java Medium Level 3! Create a program that calculates factorial using for loop.'),
