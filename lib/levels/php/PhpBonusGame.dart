// lib/levels/php/PhpBonusGame.dart
  ...
  List<Map<String, dynamic>> questions = [
    {
      ...
      'correctAnswer': 'echo',
      'options': ['echo', 'print', 'cout', 'System.out.println']
    },
    {
      'question': 'How do you start a PHP variable?',
      'tagalogQuestion': 'Paano magsimula ng variable sa PHP?',
      'correctAnswer': '\$',
      'options': ['\$', '@', '#', 'var']
    },
    {
      'question': 'What is the correct way to end a PHP statement?',
      'tagalogQuestion': 'Ano ang tamang paraan para tapusin ang PHP statement?',
      'correctAnswer': ';',
      'options': [',', ';', ':', '.']
    },
    {
      'question': 'Which symbol is used for concatenation in PHP?',
      'tagalogQuestion': 'Anong symbol ang ginagamit para sa concatenation sa PHP?',
      'correctAnswer': '.',
      'options': ['.', '+', '&', '|']
    },
    {
      'question': 'How do you start a PHP code block?',
      'tagalogQuestion': 'Paano magsimula ng PHP code block?',
      'correctAnswer': '<?php',
      'options': ['<?php', '<?', '<php', '<?PHP']
    }
  ];
  ...
  Future<void> saveScoreToDatabase(int score) async {
    ...
    try {
      ...
      final response = await ApiService.saveScore(
        currentUser!['id'],
        'PHP',
        99, // Use level 99 for bonus game instead of level 4
        score,
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 10 * _scaleFactor),
                  Text(
                    "Answer 5 questions about PHP fundamentals!",
                    textAlign: TextAlign.center,
