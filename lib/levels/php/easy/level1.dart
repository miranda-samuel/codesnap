...
class _PhpLevel1State extends State<PhpLevel1> {
  ...
  Future<void> _loadGameConfig() async {
    try {
      ...
      final response = await ApiService.getGameConfig('PHP', 1);

      print('🔍 PHP GAME CONFIG RESPONSE:');
  ...
  void _initializeGameFromConfig() {
    ...
    try {
      print('🔄 INITIALIZING PHP GAME FROM CONFIG');
  ...
  String _getDefaultHint() {
    return "💡 Hint: PHP uses echo for output. Don't forget the semicolon at the end!";
  }
  ...
  void startGame() {
    ...
    print('🎮 PHP GAME STARTED - Initial Score: $score, Timer: $timerDuration seconds');
    startTimers();
  }
  ...
  Future<void> saveScoreToDatabase(int score) async {
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        print('✅ PHP SCORE SAVED SUCCESSFULLY TO DATABASE');
      } else {
        print('❌ FAILED TO SAVE SCORE: ${response['message']}');
      }
    } catch (e) {
      print('❌ ERROR SAVING PHP SCORE: $e');
    }
  }
  ...
  Future<void> loadScoreFromDatabase() async {
    ...
    try {
      ...
      print('Error loading PHP score: $e');
    }
  }
  ...
  bool isIncorrectBlock(String block) {
    ...
    // Default incorrect blocks for PHP
  ...
  void checkAnswer() async {
    ...
    if (gameConfig != null) {
      ...
      // Fallback check for PHP Level 1
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("Excellent work PHP Beginner!"),
              SizedBox(height: 10),
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: Text("🐘 PHP - Level 1", style: TextStyle(fontSize: 18)),
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Text(
                  "Loading PHP Game Configuration...",
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text(
                    gameConfig?['objective'] ?? "🎯 PHP Level 1 Objective",
                    style: TextStyle(fontSize: 18 * _scaleFactor, fontWeight: FontWeight.bold, color: Colors.purple[800]),
                    textAlign: TextAlign.center,
                  ),
                  SizedBox(height: 10 * _scaleFactor),
                  Text(
                    gameConfig?['objective'] ?? "Learn basic PHP output with echo statement",
                    textAlign: TextAlign.center,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isTagalog
                ? (gameConfig?['story_tagalog'] ?? 'Ito ay Level 1 ng PHP programming! Simulan ang iyong PHP journey.')
                : (gameConfig?['story_english'] ?? 'This is PHP Level 1! Start your PHP programming journey.'),
