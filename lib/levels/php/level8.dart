...
class PhpLevel8 extends StatefulWidget {
  ...
  @override
  State<PhpLevel8> createState() => _PhpLevel8State();
}

class _PhpLevel8State extends State<PhpLevel8> {
  ...
  void checkAnswer() async {
    ...
    // Check for correct PHP array and foreach loop
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("Excellent! You created PHP arrays and used foreach loops to iterate through them!"),
              SizedBox(height: 10),
              Text("Your Score: $score/3", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.green)),
              SizedBox(height: 10),
              if (score == 3)
                Text(
                  "🎉 Perfect! You've completed PHP Level 8!",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("🐘 PHP - Level 8", style: TextStyle(fontSize: 18 * _scaleFactor)),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('🧩 Arrange the 6 correct blocks to create arrays and foreach loops',
