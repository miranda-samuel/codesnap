...
class PhpBonusGame extends StatefulWidget {
  const PhpBonusGame({super.key});

  @override
  State<PhpBonusGame> createState() => _PhpBonusGameState();
}

class _PhpBonusGameState extends State<PhpBonusGame> {
  ...
  // Questions and Answers for PHP
  List<Map<String, dynamic>> questions = [
    {
      'question': 'What is used to output text in PHP?',
      'tagalogQuestion': 'Ano ang ginagamit para mag-output ng text sa PHP?',
      'correctAnswer': 'echo',
      'options': ['echo', 'cout', 'printf', 'print'],
      'points': 10
    },
    {
  ...
  void _navigateToLevel6() {
    // Direct navigation to PhpLevel6 widget using MaterialPageRoute
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => PhpLevel6(), // Make sure this class exists
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.amber[700], // SAME AMBER THEME AS PYTHON
        actions: gameStarted
            ? [
          Padding(
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color(0xFF1A1A00), // SAME DARK YELLOW THEME AS PYTHON
              Color(0xFF333300),
              Color(0xFF4D4D00),
            ],
          ),
          ...
          children: [
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor: Colors.amber[700], // SAME AMBER BUTTON AS PYTHON
              ),
            ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Colors.amber[50]!.withOpacity(0.9), // SAME AMBER CONTAINER AS PYTHON
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            padding: EdgeInsets.all(16 * _scaleFactor),
            decoration: BoxDecoration(
              color: Colors.amber[100]!.withOpacity(0.9), // SAME AMBER CARD AS PYTHON
              borderRadius: BorderRadius.circular(12 * _scaleFactor),
              border: Border.all(
            ...
            children: answerBlocks.map((answer) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected ? Colors.amber[600] : Colors.amber[700], // SAME AMBER BUTTONS AS PYTHON
