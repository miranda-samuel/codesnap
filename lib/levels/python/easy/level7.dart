...
class _PythonLevel7State extends State<PythonLevel7> {
  ...
  void _autoDragCorrectBlocks() {
    // Correct blocks for Python Level 7: Dictionary iteration with grading system
  ...
  String _getLevelHint() {
    return "The correct code is:\n\nstudent_grades = {\"Math\": 90, \"Science\": 85, \"English\": 92}\nfor subject, grade in student_grades.items():\n    if grade >= 90:\n        print(f\"{subject}: A\")\n    else if grade >= 80:\n        print(f\"{subject}: B\")\n\n💡 Hint: Create a dictionary, use .items() to loop through key-value pairs, and use if-else if to assign letter grades!";
  }
  ...
  void resetBlocks() {
    // Correct blocks for Python: Dictionary manipulation with loop
    List<String> correctBlocks = [
      'student_grades = {"Math": 90, "Science": 85, "English": 92}',
      'for subject, grade in student_grades.items():',
      '    if grade >= 90:',
    ...
    List<String> incorrectBlocks = [
      ...
      'cout << subject << ": A" << endl;',
      'for subject, grade in student_grades.keys():',
      'for subject, grade in student_grades.values():',
      'student_grades = dict(Math=90, Science=85, English=92)',
      'while subject, grade in student_grades:',
    ];
  ...
  Future<void> loadScoreFromDatabase() async {
    ...
    try {
      ...
      if (response['success'] == true && response['scores'] != null) {
        ...
        final level7Data = scoresData['7']; // Level 7
  ...
  void checkAnswer() async {
    ...
    // Check for correct Python dictionary iteration with grading system
    ...
    // Expected: student_grades={"math":90,"science":85,"english":92}forsubject,gradeinstudent_grades.items():ifgrade>=90:print(f"{subject}:a")elseifgrade>=80:print(f"{subject}:b")
    String expected = 'student_grades={"math":90,"science":85,"english":92}forsubject,gradeinstudent_grades.items():ifgrade>=90:print(f"{subject}:a")elseifgrade>=80:print(f"{subject}:b")';
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("Excellent Python Dictionary Programming!"),
              SizedBox(height: 10),
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Math: A", style: TextStyle(color: Colors.white, fontFamily: 'monospace', fontSize: 14)),
                    Text("Science: B", style: TextStyle(color: Colors.white, fontFamily: 'monospace', fontSize: 14)),
                    Text("English: A", style: TextStyle(color: Colors.white, fontFamily: 'monospace', fontSize: 14)),
                  ],
                ),
              ),
            ],
            ...
            TextButton(
              onPressed: () {
                ...
                if (score == 3) {
                  ...
                  Navigator.pushReplacementNamed(context, '/python_level8');
                } else {
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildUserCodeLine(4, droppedBlocks.length > 3 ? droppedBlocks[3] : '', indent: 2),
                          _buildUserCodeLine(5, droppedBlocks.length > 4 ? droppedBlocks[4] : '', indent: 1),
                          _buildUserCodeLine(6, droppedBlocks.length > 5 ? droppedBlocks[5] : '', indent: 2),
                        ],
                      ),
                    ),
                  ],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("🐍 Python - Level 7", style: TextStyle(fontSize: 18 * _scaleFactor)),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 10 * _scaleFactor),
                  Text(
                    "Create a Python program that:\n• Creates a dictionary of student grades\n• Uses .items() to iterate through key-value pairs\n• Implements a grading system with if-else if\n• Prints the subject and corresponding grade letter\n• Classifies grades: A (90+), B (80-89)",
                    textAlign: TextAlign.center,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isTagalog
                ? 'Si Professor Reyes ay nangangailangan ng program para i-automate ang grading system! Kailangan niyang i-iterate ang student grades dictionary at i-classify ang bawat grade sa letter grade. Gamitin ang .items() method at if-else if statements!'
                : 'Professor Reyes needs a program to automate the grading system! He needs to iterate through a student grades dictionary and classify each grade into letter grades. Use .items() method and if-else if statements!',
            textAlign: TextAlign.justify,
            style: TextStyle(fontSize: 16 * _scaleFactor, color: Colors.white70),
          ),
          SizedBox(height: 20 * _scaleFactor),

          Text('🧩 Arrange the 6 correct blocks to create the grading program',
