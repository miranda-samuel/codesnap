...
class _PythonLevel2State extends State<PythonLevel2> {
  ...
  void _autoDragCorrectBlocks() {
    // Correct blocks for Python Level 2: name = "Juan"
  ...
  String _getLevelHint() {
    return "The correct code is: name = \"Juan\"\n\n💡 Hint: In Python, you don't need keywords like 'var' or 'let' to declare variables. Just use the variable name, equals sign, and the value in quotes!";
  }
  ...
  void checkAnswer() async {
    ...
    // Exact match for Python variable assignment
    String expected = 'name="juan"';
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 10 * _scaleFactor),
                  Text(
                    "Create a Python variable called 'name' and assign it the value 'Juan'",
                    textAlign: TextAlign.center,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isTagalog
                ? 'Ngayon, gusto ni Juan na gumawa ng variable para sa kanyang pangalan! Tulungan siyang gumawa ng variable na "name" at i-assign ang value na "Juan".'
                : 'Now, Juan wants to create a variable for his name! Help him create a variable called "name" and assign it the value "Juan".',
            textAlign: TextAlign.justify,
            style: TextStyle(fontSize: 16 * _scaleFactor, color: Colors.white70),
          ),
          SizedBox(height: 20 * _scaleFactor),

          Text('🧩 Arrange the 4 blocks to create a variable called "name" with value "Juan"',
