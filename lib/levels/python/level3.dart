...
class _PythonLevel3State extends State<PythonLevel3> {
  ...
  Future<void> saveScoreToPrefs(int score) async {
    ...
    if (score == 3) {
      ...
      await prefs.setBool('Python_level3_completed', false);
      setState(() {
  ...
  void checkAnswer() async {
    ...
    String normalizedCorrect = 'if5>3:print("Yes")'.toLowerCase();
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("Great job with conditionals!"),
              SizedBox(height: 10),
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () async {
              final prefs = await SharedPreferences.getInstance();
              await prefs.remove('Python_level3_completed');
              await prefs.remove('Python_level3_score');
              setState(() {
                level3Completed = false;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isTagalog
                ? 'Ngayon, natututo si Zeke tungkol sa mga kondisyon! Gusto niyang suriin kung 5 ay mas malaki kaysa sa 3 at mag-print ng "Yes" kung totoo. Pwede mo ba siyang tulungan?'
                : 'Now, Zeke is learning about conditionals! He wants to check if 5 is greater than 3 and print "Yes" if true. Can you help him?',
            textAlign: TextAlign.justify,
            style: TextStyle(fontSize: 16),
          ),
          SizedBox(height: 20),
          Text('🧩 Arrange the puzzle blocks to form: if 5 > 3:\n    print("Yes")',
