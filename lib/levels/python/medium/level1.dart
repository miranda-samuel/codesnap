...
class _PythonLevel1MediumState extends State<PythonLevel1Medium> {
  ...
  int score = 3;
  int remainingSeconds = 240; // 3 minutes for Python medium
  ...
  String _getLevelHint() {
    return "MEDIUM: Build a complete Python program with function definition, variables, and function call!";
  }
  ...
  Future<void> saveScoreToDatabase(int score) async {
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        print('Score saved successfully: $score for Python Medium Level 1');
      } else {
    ...
    try {
      ...
      if (response['success'] == true && response['scores'] != null) {
        ...
        if (level1Data != null) {
          ...
          print('Loaded previous score: $previousScore for Python Medium Level 1');
        }
      }
    } catch (e) {
  ...
  void checkAnswer() async {
    ...
    bool hasLength = normalizedAnswer.contains('length=10');
    bool hasWidth = normalizedAnswer.contains('width=5');
    bool hasFunctionCall = normalizedAnswer.contains('result=calculate_area(length,width)');
    bool hasPrint = normalizedAnswer.contains('print(f"area:{result}")');

    if (hasFunctionDef && hasAreaCalculation && hasReturn && hasLength && hasWidth && hasFunctionCall && hasPrint) {
      countdownTimer?.cancel();
      scoreReductionTimer?.cancel();
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("Excellent! You built a complete Python program!"),
              SizedBox(height: 10),
              ...
              if (score == 3)
                Text(
                  "🎉 Perfect! You've mastered Python Medium Level!",
            ...
            TextButton(
              onPressed: () {
                ...
                if (score == 3) {
                  ...
                  Navigator.pushReplacementNamed(context, '/python_level2_medium');
                } else {
      ...
      if (score > 1) {
        ...
        showDialog(
          ...
          builder: (_) => AlertDialog(
            title: Text("💀 Game Over"),
            content: Text("Remember to build a complete Python program with function definition and proper syntax."),
            actions: [
              TextButton(
                onPressed: () {
                  musicService.playSoundEffect('click.mp3');
  ...
  Widget _buildCodeContent() {
    ...
    for (String block in droppedBlocks) {
      ...
      bool isVariable = block.contains('=') && !isFunctionDef && !isReturn;
      ...
      if (block != 'def calculate_area(length, width):' &&
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("🐍 Python - Level 1 (Medium)", style: TextStyle(fontSize: 18 * _scaleFactor)),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 10 * _scaleFactor),
                  Text(
                    "Build a complete Python program with function definition, variables, and function call",
                    textAlign: TextAlign.center,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isTagalog
                ? 'Si Maria ay gustong gumawa ng Python program para kalkulahin ang area ng rectangle! Kailangan niyang gumamit ng function, variables, at function call. Tulungan siyang buuin ang program!'
                : 'Maria wants to create a Python program to calculate the area of a rectangle! She needs to use a function, variables, and function call. Help her build the program!',
            textAlign: TextAlign.justify,
            style: TextStyle(fontSize: 16 * _scaleFactor, color: Colors.white70),
          ),
          SizedBox(height: 20 * _scaleFactor),

          Text('🧩 Build the complete Python program using all 7 blocks',
