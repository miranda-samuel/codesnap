...
class _SqlLevel1State extends State<SqlLevel1> {
  ...
  void resetBlocks() {
    // Simple blocks for SQL SELECT query - SELECT * FROM users;
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              Text("Your Query:", style: TextStyle(fontWeight: FontWeight.bold)),
              Container(
                padding: EdgeInsets.all(10),
  ...
  // BAGONG PREVIEW NA MAY CODE EDITOR STYLE (SQL VERSION)
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 10),
                Text(
                  "Arrange the code blocks to create: SELECT * FROM users;",
                  textAlign: TextAlign.center,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('🧩 Arrange the blocks to form: SELECT * FROM users;',
          ...
          SizedBox(height: 20),
          Text('💻 Query Preview:', style: TextStyle(fontWeight: FontWeight.bold, fontSize: isSmallScreen ? 16 : 18)),
          SizedBox(height: 10),
          ...
          ElevatedButton.icon(
            ...
            icon: Icon(Icons.play_arrow),
            label: Text("Run Query", style: TextStyle(fontSize: isSmallScreen ? 14 : 16)),
            style: ElevatedButton.styleFrom(
              backgroundColor: Colors.orange,
