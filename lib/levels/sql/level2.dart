...
class _SqlLevel2State extends State<SqlLevel2> {
  ...
  void resetBlocks() {
    // Reduced blocks for SQL SELECT with specific columns
    allBlocks = [
      'SELECT',
      'name,',
      'age',
  ...
  Future<void> saveScoreToPrefs(int score) async {
    ...
    if (score == 3) {
      ...
      await prefs.setBool('SQL_level2_completed', false);
      setState(() {
  ...
  void checkAnswer() async {
    ...
    String normalizedCorrect = 'selectname,agefromuserswherecountry="philippines";'.toLowerCase();
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("Great job with SQL SELECT queries!"),
              SizedBox(height: 10),
              ...
              Container(
                ...
                color: Colors.black,
                child: Text(
                  "Names and ages of users from Philippines",
                  style: TextStyle(
                    color: Colors.white,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("🗃️ SQL - Level 2: SELECT Specific Columns"),
        ...
        children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 5),
                  Text(
                    "You've mastered specific column selection!",
                    style: TextStyle(color: Colors.orange, fontWeight: FontWeight.bold),
                  ),
                ],
              ),
          ...
          ElevatedButton(
            onPressed: () async {
              final prefs = await SharedPreferences.getInstance();
              // Use consistent key format with LevelSelectionScreen
              await prefs.remove('SQL_level2_completed');
              await prefs.remove('SQL_level2_score');
              setState(() {
                level2Completed = false;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isTagalog
                ? 'Ngayon, natututo si Zeke tungkol sa pagpili ng specific na columns sa SQL! Kailangan niyang kunin ang pangalan at edad ng mga users mula sa Pilipinas. Pwede mo ba siyang tulungan?'
                : 'Now, Zeke is learning about selecting specific columns in SQL! He needs to retrieve the names and ages of users from the Philippines. Can you help him?',
