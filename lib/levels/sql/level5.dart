...
class _SqlLevel5State extends State<SqlLevel5> {
  ...
  String _getLevelHint() {
    return "The correct SQL query is: SELECT c.name, COUNT(o.id) FROM customers c JOIN orders o ON c.id = o.customer_id GROUP BY c.name HAVING COUNT(o.id) > 2;\n\n💡 Hint: Start with 'SELECT c.name, COUNT(o.id) FROM', then 'customers c JOIN orders o', followed by 'ON c.id = o.customer_id', then 'GROUP BY c.name', and finally 'HAVING COUNT(o.id) > 2;'";
  }
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              padding: EdgeInsets.all(12 * _scaleFactor),
              margin: EdgeInsets.only(top: 20 * _scaleFactor),
              decoration: BoxDecoration(
